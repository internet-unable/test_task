...
function addAnswerToArray(item) {
    answersArray.push(item);
}

function stepfinal(event) {
...
jQuery(document).ready(function () {
    ...
    $(".bq1").click(function (event) {
        addAnswerToArray(event.currentTarget.textContent);
        $("#q1").fadeOut("slow", function () {
            $("#q2").fadeIn("slow")
        })
    }), $(".bq2").click(function (event) {
        addAnswerToArray(event.currentTarget.textContent);
        $("#q2").fadeOut("slow", function () {
            $("#q3").fadeIn("slow")
        })
    }), $(".bq3").click(function (event) {
        addAnswerToArray(event.currentTarget.textContent);
    ...
    boxRoot = {
        _init: function () {
            setTimeout(function () {
                ...
                e.stopPropagation(), jQuery("#p_modal3").modal("hide"), stepfinal(event)
            })
        }
    }, jQuery(document).ready(function () {
